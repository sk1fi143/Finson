      ...
      <div className="AboutUs-top-main">
        <div className="AboutUs-top-main__info">
          ...
          <p className="AboutUs-top-main__text-info">
            ...
            fuerit causa, mox videro; interea hoc tenebo, si ob rem voluptas assumenda est, quid sit
            extremum et inter mediocrem animadversionem atque natum sit, a natura incorrupte.            Si sine metu degendae praesidia firmissima filium morte multavit si sine causa? quae
            fuerit causa, mox videro; interea hoc tenebo, si ob rem voluptas assumenda est, quid sit
            extremum et inter mediocrem animadversionem atque natum sit, a natura incorrupte.
          </p>
        </div>
        ...
        <div className="AboutUs-bottom-main__contacts">
          ...
          <div className="AboutUs-bottom-main__navigat-block">
            <div className="AboutUs-bottom-main__contact-element">
              <Place />
              <span className="AboutUs-bottom-main__name">Тайланд, Пхукет</span>
            </div>
            <div className="AboutUs-bottom-main__contact-element">
              <Mail />
              <span className="AboutUs-bottom-main__name">mail@yandex.ru</span>
            </div>
            <div className="AboutUs-bottom-main__contact-element">
              <Tel />
              <span className="AboutUs-bottom-main__name">+66 627 352 808</span>
            </div>
          </div>
          ...
          <div className="AboutUs-bottom-main__navigat-block">
            <div className="AboutUs-bottom-main__social-network-element">
              <div className="AboutUs-bottom-main__social-network-info">
                <Inst />
                <span className="AboutUs-bottom-main__name">finson</span>
              </div>
            ...
            <div className="AboutUs-bottom-main__social-network-element">
              ...
              <button className="AboutUs-bottom-main__social-button">
                <a className="AboutUs-bottom-main__text-button" href="https://telegram.org/?1">
                  Написать
                </a>
              </button>
            </div>
